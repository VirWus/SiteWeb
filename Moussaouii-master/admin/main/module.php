            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Ajouter Module</h3>
                        <ol class="breadcrumb">
                ...
                <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card"><!-- Tab panes -->
                            <div class="card-body">
                              <form class="form-horizontal form-material" method="POST" action="php/addmodule.php" enctype="multipart/form-data">
...
$i=0;
$conn=mysqli_connect('localhost','root','','siteweb');
$resultat=mysqli_query($conn,'SELECT * From module');
?>
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>  
                                                ...
                                                <td><?php   echo $row["module_annee"]; ?></td>
                                    ...
                                    <div class="form-group" style="display: inline;" >
                                        ...
                                        <div class="col-sm-12">
                                            <a href="php/supmodule.php?id=<?php echo $row["id_module"]; ?>">Suprimer</a>
                                        </div>
                                    </div>
                                     </td>
                                            </tr>
