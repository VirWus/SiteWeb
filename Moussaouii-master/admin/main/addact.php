...
<html lang="en"><head>
    ...
    <title>Admin | Ajouter Actualité</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Ajouter Actualité</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Accueil</a></li>
                            <li class="breadcrumb-item active">Ajouter Actualité</li>
                        </ol>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material" method="POST" action="php/addactualite.php"   enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Titre" class="form-control form-control-line" name="titre">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="10" class="form-control form-control-line" placeholder="Description" name="contenu"></textarea>
                                        </div>
                                    </div>
                                       <div class="form-group">
