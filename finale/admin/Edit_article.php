...
<li>
                        <a href="article.php"> <i class="menu-icon fa fa-pencil-square-o" style="color:#e74c3c;"></i>Article </a>
                    </li>
                    <li>
...
<a class="nav-link" href="../engine/logout.php"><i class="fa fa-power -off"></i>Logout</a>
 ...
 <?php
                   ...
                   <div class="col-lg-6">
                    <div class="card">
                      <div class="card-header">Modifier votre Article</div>
                      <div class="card-body card-block">
                      <form action="add-article.php" method="POST" enctype="multipart/form-data" >
                          <div class="form-group">
                            <p> Titre :</p>
                            <div class="input-group">
                              <input type="text" id="titre" name="titre"  value="<?php echo base64_decode($Rs['titre']); ?>" placeholder="Titre" class="form-control">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <input type="date" id="date" name="date_de_pub"  value="<?php echo base64_decode($Rs['date_de_pub']); ?>" placeholder="Date" class="form-control">
                          ...
                          <div class="form-group">
                            <p> Déscription :  :</p>
                            <div class="input-group ">
                              <input type="text" id="description" name="description"  value="<?php echo base64_decode($Rs['description']); ?>" placeholder="déscription" class="form-control">
                          ...
                          <p> Lien :</p>
                            <div class="input-group">
                              <input type="hidden" id="lien" name="lien" value="<?php echo base64_decode($Rs['lien']); ?>" placeholder="lien" class="form-control">
