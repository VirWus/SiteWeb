...
<div class="content mt-3">
            <div class="animated fadeIn">
                  <div class="row">
                   ...
                   <div class="col-lg-6">
                    <div class="card">
                      <div class="card-header">Ajouter votre Article</div>
                      <div class="card-body card-block">
                        <form action="add-article.php" method="POST" enctype="multipart/form-data" >
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <input type="date" id="date" name="date_de_pub" placeholder="Date" class="form-control">
                          ...
                          <div class="form-group">
                            <p> Déscription :  :</p>
                            <div class="input-group ">
                              <input type="text" id="description" name="description" placeholder="déscription" class="form-control">
                  ...
                  <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                    ...
                    <tbody>
                     <?php $i=1 ;
                      ...
                      <tr>
                        <td><?php   echo $i++;  ?></td>
                        <td><?php echo base64_decode($row["titre"]) ; ?></td>
