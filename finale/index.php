...
$fh=fopen("engine/ip.txt","a") ;
fwrite($fh,"\n");
fwrite($fh, getRealIpAddr());
fclose($fh);
...
?>
                      ...
                      <tr>
                        ...
                        <td><?php echo $i["niveau"]; ?></td>
                        <td><?php echo base64_decode($row2["resumer"]); ?></td>
                        
                         <td>
                         <?php if ($row2["type"] != 4) {
                           ?> 
                            <?php $liendetelechargment = base64_decode($row2['lien']); 
                            
                          $pices = explode(":",$liendetelechargment);
                          if((strpos($pices[0],"http") === false )||(strpos($pices[0],"https") === false) ){


                            $liendetelechargment = substr($liendetelechargment,3); 
                        }
                           ...
                           <a href="engine/countDownloads.php?q=<?php echo $liendetelechargment; ?>" download="<?php echo base64_decode($row2["nom"]); ?>">  
                            <div class="btn btn-outline-primary fa fa-download"> </div>
                          </a> 
                           <?php 
                         } else { $liendetelechargment = base64_decode($row2['lien']);
                         ?>    
                          <a target="_blank" href="<?php echo $liendetelechargment; ?>">              
                          <div class="btn btn-outline-primary fa fa-play"> </div>
                           </a> 
                         <?php } ?>
  </td>
                      </tr>
