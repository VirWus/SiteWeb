...
jQuery(document).ready(function($) {
	...
	$("ul.colors .color3" ).click(function(){
		$("#colors" ).attr("href", "css/colors/lightblue.css" );
		return false;
	});
	...
	$("ul.colors .color6" ).click(function(){
		$("#colors" ).attr("href", "css/colors/greensea.css" );
		return false;
	});

	$("ul.colors .color7" ).click(function(){
		$("#colors" ).attr("href", "css/colors/coffee.css" );
		return false;
	});

	$("ul.colors .color8" ).click(function(){
		$("#colors" ).attr("href", "css/colors/mblue.css" );
		return false;
	});
...
jQuery('head').append('<link rel="stylesheet" id="colors" href="css/colors/green.css" type="text/css" />');
	...
	'<div id="color-style-switcher">' +
		'<div>' + 
			...
			'<ul class="colors">' +
				...
				'<li><a class="color2" class="collapse navbar-collapse" href="#"></a></li>' +
