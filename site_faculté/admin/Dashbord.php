...
<head>
    ...
    <title>Admin|Faculté Mathematique et Inforamtique</title>
    <!-- Bootstrap Core CSS -->
    <link href="a/css/lib/bootstrap/bootstrap.min.css" rel="stylesheet">
    <!-- Custom CSS -->

    <link href="a/css/lib/calendar2/semantic.ui.min.css" rel="stylesheet">
    <link href="a/css/lib/calendar2/pignose.calendar.min.css" rel="stylesheet">
    <link href="a/css/lib/owl.carousel.min.css" rel="stylesheet" />
    <link href="a/css/lib/owl.theme.default.min.css" rel="stylesheet" />
...
<body class="fix-header fix-sidebar">
                                ...
                                <div class="testimonial-widget-one owl-carousel owl-theme">
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="a/images/avatar/2.jpg" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="a/images/avatar/3.jpg" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="a/images/avatar/1.jpg" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="a/images/avatar/4.jpg" alt="" />
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="a/images/avatar/5.jpg" alt="" />
                                            <div class="testimonial-author">TYRION LANNISTER</div>
                                            <div class="testimonial-author-position">Founder-Ceo. Dell Corp</div>
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            <img class="testimonial-author-img" src="a/images/avatar/6.jpg" alt="" />
                                            <div class="testimonial-author">TYRION LANNISTER</div>
                                            <div class="testimonial-author-position">Founder-Ceo. Dell Corp</div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img src="a/images/avatar/4.jpg" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>John Abraham</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img src="a/images/avatar/2.jpg" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>John Abraham</td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="round-img">
                                                        <a href=""><img src="a/images/avatar/3.jpg" alt=""></a>
                                                    </div>
                                                </td>
                                                <td>John Abraham</td>
								...
								<div class="recent-comment">
									<div class="media">
										<div class="media-left">
											<a href="#"><img alt="..." src="a/images/avatar/1.jpg" class="media-object"></a>
										</div>
    ...
    <!-- Amchart -->
     <script src="a/js/lib/morris-chart/raphael-min.js"></script>
    <script src="a/js/lib/morris-chart/morris.js"></script>
    <script src="a/js/lib/morris-chart/dashboard1-init.js"></script>


	<script src="a/js/lib/calendar-2/moment.latest.min.js"></script>
    <!-- scripit init-->
    <script src="a/js/lib/calendar-2/semantic.ui.min.js"></script>
    <!-- scripit init-->
    <script src="a/js/lib/calendar-2/prism.min.js"></script>
    <!-- scripit init-->
    <script src="a/js/lib/calendar-2/pignose.calendar.min.js"></script>
    <!-- scripit init-->
    <script src="a/js/lib/calendar-2/pignose.init.js"></script>

    <script src="a/js/lib/owl-carousel/owl.carousel.min.js"></script>
    <script src="a/js/lib/owl-carousel/owl.carousel-init.js"></script>
