                   ...
                   <div class="col-lg-6">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="Support(add).php" method="post" enctype="multipart/form-data" class="">
                          ...
                          <div class="form-group">  
                           ...
                           <div class="form-group">
                            <div class="input-group ">
                              <input type="text" id="module" name="module" placeholder="Module" class="form-control">
                    ...
                    <tbody>
                     <?php $i=1 ;
                      ...
                      <tr>
                        ...
                        <td> <a href="Support(update).php?id=<?php echo $row["id"];?>"><button type="button" class="btn btn-outline-success fa fa-wrench btn-lg"></button></a>    
                            <a href="Support(delete).php?id=<?php echo $row["id"];?>"><button type="button" class="btn btn-outline-danger fa fa-trash btn-lg"></button> </a>
                           <a href="Support(previeuw).php?id=<?php echo $row["id"];?>"><button type="button" class="btn btn-outline-warning fa fa-eye btn-lg"></button> </a>
                        </td>
